...
- [x] **SQL & Tableau** - 
    * Airlines Database $\parallel$ Database Query for Flight Ticket Sales Analysis (PostgreSQL) $\leadsto$ [view](https://github.com/seuwenfei/Airlines-flight-ticket-sales-analysis)
